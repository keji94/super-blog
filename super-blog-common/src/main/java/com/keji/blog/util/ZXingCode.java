...
/**
 * @author wb-ny291824
 * @version $Id: ZXingCode.java, v 0.1 2017-12-15 15:27 wb-ny291824 Exp $$
 */
    ...
    public String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName) {
        try {
            ...
            int widthLogo = logo.getWidth(null) > image.getWidth() * 3 / 10 ? (image.getWidth() * 3 / 10)
                                                                            : logo.getWidth(null), heightLogo =
                    logo.getHeight(null) > image.getHeight() * 3 / 10 ? (image.getHeight() * 3 / 10) : logo.getWidth(
                            null);
            ...
            ImageIO.write(image, "png",
                    new File("C:/Users/luoguohui/Desktop/TDC-" + System.currentTimeMillis() + "test.png"));
