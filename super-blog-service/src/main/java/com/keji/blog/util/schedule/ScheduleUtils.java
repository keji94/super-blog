...
public class ScheduleUtils {
    ...
    public static CronTrigger getCronTrigger(Scheduler scheduler, Long jobId) {
        try {
            ...
            throw new BlogException("获取定时任务CronTrigger出现异常", e);
        }
    }
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJobDO scheduleJob) {
        try {
            ...
            //放入参数，运行时的方法可以获取
            jobDetail.getJobDataMap().put(BlogConstants.JOB_PARAM_KEY, scheduleJob);
            ...
            throw new BlogException("创建定时任务失败", e);
        }
    }
    ...
    public static void updateScheduleJob(Scheduler scheduler, ScheduleJobDO scheduleJob) {
        try {
            ...
            //参数
            trigger.getJobDataMap().put(BlogConstants.JOB_PARAM_KEY, scheduleJob);
            ...
            throw new BlogException("更新定时任务失败", e);
        }
    }
    ...
    public static void pauseJob(Scheduler scheduler, Long jobId) {
        try {
            ...
            throw new BlogException("暂停定时任务失败", e);
        }
    }
    ...
    public static void deleteScheduleJob(Scheduler scheduler, Long jobId) {
        try {
            ...
            throw new BlogException("删除定时任务失败", e);
        }
    }
}
